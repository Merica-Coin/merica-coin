...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR MERICAS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
        ...
        if(retval == QMessageBox::Yes)
        {
            if(newpass1 == newpass2)
            {
                ...
                "your mericas from being stolen by malware infecting your computer.");
                if (m_passphrase_out) {
