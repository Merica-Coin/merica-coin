...
//! Entry point for MERICAApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MERICAApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MERICAGUI tests.
void AppTests::guiTests(MERICAGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MERICAGUI::consoleShown, this, &AppTests::consoleTests);
