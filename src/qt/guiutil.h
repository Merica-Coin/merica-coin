...
#ifndef MERICA_QT_GUIUTIL_H
#define MERICA_QT_GUIUTIL_H
...
/** Utility functions used by the MERICA Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "merica:" URI into recipient object, return true on successful parsing
