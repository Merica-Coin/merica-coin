    ...
    platformStyle(_platformStyle)
{
    ...
    // normal merica address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying merica address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MERICAAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
