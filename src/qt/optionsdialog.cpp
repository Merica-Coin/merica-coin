    ...
    mapper(nullptr)
{
    ...
    ui->mericaAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->mericaAtStartup);
    ...
    ui->mericaAtStartup->setToolTip(ui->mericaAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->mericaAtStartup->setText(ui->mericaAtStartup->text().arg(PACKAGE_NAME));

    ui->openMERICAConfButton->setToolTip(ui->openMERICAConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MERICAUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->mericaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMERICAConfButton_clicked()
{
