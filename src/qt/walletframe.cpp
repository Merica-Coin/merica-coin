...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, MERICAGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &MERICAGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &MERICAGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &MERICAGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &MERICAGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &MERICAGUI::updateWalletStatus);
    connect(gui, &MERICAGUI::setPrivacy, walletView, &WalletView::setPrivacy);
