...
#ifndef MERICA_WALLET_WALLETUTIL_H
#define MERICA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! merica from opening the wallet, thinking it was newly created, and
...
#endif // MERICA_WALLET_WALLETUTIL_H
