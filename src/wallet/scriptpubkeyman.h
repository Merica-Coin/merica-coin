...
#ifndef MERICA_WALLET_SCRIPTPUBKEYMAN_H
#define MERICA_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The MERICA Core wallet was originally a collection of unrelated private
...
#endif // MERICA_WALLET_SCRIPTPUBKEYMAN_H
