...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/merica/merica/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/merica/merica/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint64_t mempool_sequence) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/merica/merica/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/merica/merica/pull/9371 and the prior sync
        ...
        // https://github.com/merica-core/merica-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, {CWalletTx::Status::UNCONFIRMED, /* block height */ 0, /* block hash */ {}, /* index */ 0});
    }
}
    ...
    while (!fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, FoundBlock().data(block)) && !block.IsNull()) {
            ...
            if (reorg) {
                ...
                // https://github.com/merica/merica/pull/14711#issuecomment-458342518
        ...
        bool sign)
{
    ...
    int nBytes;
    {
        ...
        txNew.nLockTime = GetLocktimeForNewTransaction(chain(), GetLastBlockHash(), GetLastBlockHeight());
        {
            ...
            // change transaction isn't always pay-to-merica-address
 ...
 * https://mericatalk.org/?topic=54527, or
 * https://github.com/merica/merica/pull/1393.
 */
