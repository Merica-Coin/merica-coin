...
#ifndef MERICA_COMPAT_ASSUMPTIONS_H
#define MERICA_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "MERICA cannot be compiled without assertions."
#endif
...
#endif // MERICA_COMPAT_ASSUMPTIONS_H
