...
std::string SHA256AutoDetect()
{
...
#if defined(ENABLE_SHANI) && !defined(BUILD_MERICA_INTERNAL)
    if (have_shani) {
    ...
    if (have_sse4) {
        ...
        ret = "sse4(1way)";
#endif
#if defined(ENABLE_SSE41) && !defined(BUILD_MERICA_INTERNAL)
        TransformD64_4way = sha256d64_sse41::Transform_4way;
        ret += ",sse41(4way)";
#endif
    }

#if defined(ENABLE_AVX2) && !defined(BUILD_MERICA_INTERNAL)
