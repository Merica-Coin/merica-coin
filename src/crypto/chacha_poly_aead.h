...
#ifndef MERICA_CRYPTO_CHACHA_POLY_AEAD_H
#define MERICA_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@merica.
 *
 ...
 *
 * The chacha20-poly1305@merica combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@merica cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@merica are relatively fast in
...
#endif // MERICA_CRYPTO_CHACHA_POLY_AEAD_H
