...
#ifndef MERICA_TEST_SCRIPTNUM10_H
#define MERICA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MERICA Core 0.10.0, for cross-comparison.
 */
public:
