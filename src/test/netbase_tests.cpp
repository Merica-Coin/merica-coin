...
{
    BOOST_CHECK(TestSplitHost("www.mericacore.org", "www.mericacore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.mericacore.org]", "www.mericacore.org", -1));
    BOOST_CHECK(TestSplitHost("www.mericacore.org:80", "www.mericacore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.mericacore.org]:80", "www.mericacore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:46062", "127.0.0.1", 46062));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:46062", "127.0.0.1", 46062));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:46062", "::ffff:127.0.0.1", 46062));
    BOOST_CHECK(TestSplitHost("[::]:46062", "::", 46062));
    BOOST_CHECK(TestSplitHost("::46062", "::46062", -1));
    BOOST_CHECK(TestSplitHost(":46062", "", 46062));
    BOOST_CHECK(TestSplitHost("[]:46062", "", 46062));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:46062", "127.0.0.1:46062"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:46062", "[::]:46062"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
