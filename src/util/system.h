 ...
 */
#ifndef MERICA_UTIL_SYSTEM_H
#define MERICA_UTIL_SYSTEM_H
...
extern const char * const MERICA_CONF_FILENAME;
extern const char * const MERICA_SETTINGS_FILENAME;
