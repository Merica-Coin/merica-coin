 ...
 * for both mericad and merica-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/merica/bips/blob/master/bip-0014.mediawiki)
 */
