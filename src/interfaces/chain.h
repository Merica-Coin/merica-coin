...
#ifndef MERICA_INTERFACES_CHAIN_H
#define MERICA_INTERFACES_CHAIN_H
...
//! internal workings of the merica node, and not being very convenient to use.
//! Chain methods should be cleaned up and simplified over time. Examples:
//!
//! * The initMessages() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/merica/merica/pull/15288#discussion_r253321096).
//!
...
#endif // MERICA_INTERFACES_CHAIN_H
