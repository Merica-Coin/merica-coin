...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified descriptor (before the RPC call returns)\n",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated merica to."},
...
static RPCHelpMan generatetoaddress()
{
    return RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated merica to."},
                    {"maxtries", RPCArg::Type::NUM, /* default */ ToString(DEFAULT_MAX_TRIES), "How many iterations to try."},
                },
                RPCResult{
                    RPCResult::Type::ARR, "", "hashes of blocks generated",
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated merica to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated merica to."},
...
// NOTE: Unlike wallet RPC (which use MERICA values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/merica/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/merica/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/merica/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/merica/bips/blob/master/bip-0145.mediawiki\n",
                {
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
                ...
                "See https://en.merica.it/wiki/BIP_0022 for full specification.\n",
                {
