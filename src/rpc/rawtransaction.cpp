...
{
    // Call into TxToUniv() in merica-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in merica-common, so we query them here and push the
                             ...
                             {RPCResult::Type::ARR, "vout", "",
                             {
                                 {RPCResult::Type::OBJ, "", "",
                                 {
                                     ...
                                     {RPCResult::Type::OBJ, "scriptPubKey", "",
                                     {
                                         ...
                                         {
                                             {RPCResult::Type::STR, "address", "merica address"},
                                         }},
                                     }},
                                 }},
                             }},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed MERICA transaction.\n",
                {
                            ...
                            {RPCResult::Type::OBJ, "", "",
                            {
                                ...
                                {RPCResult::Type::OBJ, "witness_utxo", /* optional */ true, "Transaction output for witness UTXOs",
                                {
                                    ...
                                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                                    {
                                        ...
                                        {RPCResult::Type::STR_HEX, "hex", "The hex"},
                                        {RPCResult::Type::STR, "type", "The type, eg 'pubkeyhash'"},
                                        {RPCResult::Type::STR, "address"," MERICA address if there is one"},
                                    }},
                                }},
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed MERICA transactions into one transaction.\n"
