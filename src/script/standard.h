...
#ifndef MERICA_SCRIPT_STANDARD_H
#define MERICA_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a merica address
 */
...
/**
 * Generate a MERICA scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MERICA_SCRIPT_STANDARD_H
