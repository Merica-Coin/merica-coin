...
void CNode::copyStats(CNodeStats &stats, const std::vector<bool> &m_asmap)
{
    ...
    // Raw ping time is in microseconds, but show it to user as whole seconds (MERICA users should be well used to small numbers with many decimal places by now :)
