...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/merica-core/merica-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['MERICA_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
        os.environ['MERICA_VERIFY_COMMITS_ALLOW_REVSIG'] = "1" if current_commit in revsig_allowed else "0"
