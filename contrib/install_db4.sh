...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the merica repository."
  exit 1
fi
...
# See https://github.com/merica/merica/issues/16064
...
echo 'When compiling mericad, run `./configure` in the following way:'
echo
