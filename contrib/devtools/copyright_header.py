...
Arguments:
    <base_directory> - The base directory of a merica source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The MERICA Core developers'
...
Arguments:
    <file> - A source file in the merica repository.
"""
