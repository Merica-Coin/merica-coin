...
When complete, it will have produced `MERICA-Qt.dmg`.
...
apt install cpio
git clone https://github.com/merica-core/apple-sdk-tools.git
...
the file-order will change between invocations. The patch can be seen here: [cdrkit-deterministic.patch](https://github.com/merica/merica/blob/master/depends/patches/native_cdrkit/cdrkit-deterministic.patch).
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/merica-core/merica-detached-sigs).
