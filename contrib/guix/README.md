# Bootstrappable MERICA Core Builds

This directory contains the files necessary to perform bootstrappable MERICA
Core builds.
...
- 24GB of free disk space on the partition that the MERICA Core git repository
  resides in
...
For a MERICA Core depends development environment, simply invoke
...
From the top of a clean MERICA Core repository:
...
To use dongcarl's substitute server for MERICA Core builds after having
