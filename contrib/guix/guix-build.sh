...
# Deterministically build MERICA Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/merica/' to
        #     '/home/satoshi/merica/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/merica
        #
        #                     maps our current working directory to /merica
        ...
        #     container so that we have something to build. '/merica' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /merica && bash contrib/guix/libexec/build.sh"
    )
