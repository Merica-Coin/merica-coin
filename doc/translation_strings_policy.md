...
This document provides guidelines for internationalization of the MERICA Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `merica_en.ts` remains unchanged.
