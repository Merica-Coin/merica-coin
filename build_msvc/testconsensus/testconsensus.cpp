...
// merica includes.
#include <..\src\script\mericaconsensus.h>
...
int main()
{
    std::cout << "mericaconsensus version: " << mericaconsensus_version() << std::endl;
    ...
    auto op0Result = mericaconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, mericaconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
