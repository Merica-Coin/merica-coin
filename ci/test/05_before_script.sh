...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/MERICA
else
  DOCKER_EXEC echo \> \$HOME/.merica
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/merica/merica/pull/18288#discussion_r433189350 for
  # details.
