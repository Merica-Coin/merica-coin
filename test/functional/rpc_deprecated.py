...
class DeprecatedRpcTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            assert_raises_rpc_error(-32, 'Using bumpfee with wallets that have private keys disabled is deprecated. Use psbtbumpfee instead or restart mericad with -deprecatedrpc=bumpfee. This functionality will be removed in 0.22', noprivs0.bumpfee, txid)
