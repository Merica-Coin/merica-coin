...
class WalletSendTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        for mode in ["economical", "conservative", "merica/kb", "sat/b"]:
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, change_address="not an address",
                       expect_error=(-5, "Change address must be a valid merica address"))
