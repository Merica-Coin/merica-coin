...
class PSBTTest(MERICATestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 MERICA
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 MERICA/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
