...
"""Check that it's not possible to start a second mericad instance using the same datadir or wallet."""
import os

from test_framework.test_framework import MERICATestFramework
from test_framework.test_node import ErrorMatch

class FilelockTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that we can't start a second mericad instance using the same datadir")
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second mericad instance using the same wallet")
