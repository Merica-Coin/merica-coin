...
class TestShell:
    """Wrapper Class for MERICATestFramework.

    The TestShell class extends the MERICATestFramework
    ...
    class __TestShell(MERICATestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MERICATestFramework child class.
            self.num_nodes = 1
