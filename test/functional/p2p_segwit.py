...
class SegWitTest(MERICATestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older mericad's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let mericad fill it in.
