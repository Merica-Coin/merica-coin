...
"""Verify that starting merica with -h works as expected."""

from test_framework.test_framework import MERICATestFramework
from test_framework.util import assert_equal

class HelpTest(MERICATestFramework):
    ...
    def run_test(self):
        self.log.info("Start merica with -h for help text")
        ...
        self.log.info("Start merica with -version for version information")
        ...
        self.log.info("Start mericad with -fakearg to make sure it does not start")
