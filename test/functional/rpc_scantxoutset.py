...
class ScantxoutsetTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 MERICA, so each amounts uniquely identifies a subset.
