...
class ConfArgsTest(MERICATestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'merica.conf'), 'a', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "merica.conf")
