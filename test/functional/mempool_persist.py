...
By default, mericad will dump mempool on shutdown and
...
class MempoolPersistTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mericad from writing mempool.dat to disk. Verify that `savemempool` fails")
