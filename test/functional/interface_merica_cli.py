...
# The block reward of coinbaseoutput.nValue (50) MERICA/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 MERICA/block.
BLOCKS = 101
...
class TestMERICACli(MERICATestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `merica-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and merica-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 MERICA) to the default wallet.
            ...
            # Test merica-cli -generate with -rpcwallet in multiwallet mode.
