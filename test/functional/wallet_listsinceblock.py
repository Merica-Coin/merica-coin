...
class ListSinceBlockTest(MERICATestFramework):
    ...
    def test_double_spend(self):
        ...
        1. User 1 receives MERICA in tx1 from utxo1 in block aa1.
        2. User 2 receives MERICA in tx2 from utxo1 (same) in block bb1
