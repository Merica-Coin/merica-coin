...
class BumpFeeTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 merica (100,000 satoshis)
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "MERICA/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by MERICA to serialize ECDSA signatures means that signatures can have a
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 MERICA / 1000 vbytes = 0.00049385 MERICA.
    # or occasionally 140 vbytes * fee_rate 0.00350250 MERICA / 1000 vbytes = 0.00049035 MERICA.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 MERICA.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 MERICA / 1000 vbytes = 0.00002820 MERICA
