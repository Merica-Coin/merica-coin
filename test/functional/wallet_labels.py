...
class WalletLabelsTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 MERICAs
        ...
        for l in BECH32_INVALID:
            ...
            assert_raises_rpc_error(
                -5,
                "Address is not valid" if self.options.descriptors else "Invalid MERICA address or script",
