...
class P2PPermissionsTests(MERICATestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].mericaconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].mericaconf, 'w', encoding="utf8") as f:
            f.write(newText)
