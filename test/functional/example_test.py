...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MERICATestFramework
    pass


class ExampleTest(MERICATestFramework):
    # Each functional test is a subclass of the MERICATestFramework class.
    ...
    def custom_method(self):
        ...
        MERICATestFramework class so other tests can use it."""
