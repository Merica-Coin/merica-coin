...
class VersionBitsWarningTest(MERICATestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because mericad will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
