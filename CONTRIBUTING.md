Contributing to MERICA Core
============================

The MERICA Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "MERICA Core
...
Before you start contributing, familiarize yourself with the MERICA Core build
system and tests. Refer to the documentation in the repository on how to build
MERICA Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/merica/merica/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/merica/merica/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[MERICA Core PR Review Club](https://mericacore.reviews/) meeting.
...
Most communication about MERICA Core development happens on IRC, in the
`#merica-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/merica-core-dev/](http://www.erisian.com.au/merica-core-dev/)
and [http://gnusha.org/merica-core-dev/](http://gnusha.org/merica-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/merica-dev)
...
For GUI-related issues or pull requests, the https://github.com/merica-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/merica/merica node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to merica-qt
...
fork of MERICA Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/merica/merica/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MERICA Core project (and related
projects such as libsecp256k1), and is not to be confused with overall MERICA
Network Protocol consensus changes.

Whether a pull request is merged into MERICA Core rests with the project merge
...
Patches that change MERICA consensus rules are considerably more involved than
...
Where a patch set proposes to change the MERICA consensus, it must have been
...
https://github.com/merica/merica/pull/16189).

Also see the [backport.py script](
https://github.com/merica-core/merica-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each MERICA Core release.
